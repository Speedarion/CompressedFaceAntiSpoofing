...
def get_dataset_from_list(data_list_path, dataset_cls, transform, num_frames=1000, root_dir=''):
    ...
    for i in range(num_file):
        ...
        face_label = int(face_labels.get(i) == 0)
        ...
        if not os.path.exists(zip_path):
            ...
            dataset = dataset_cls(zip_path, face_label,
...
if __name__ == '__main__':
    ...
    data_list, face_labels = parse_data_list(
        '/home/hazeeq/FYP-Hazeeq/data/data_list/PROTOCOL-grandtest.csv',"eval")
    print(data_list)
    print(face_labels)
