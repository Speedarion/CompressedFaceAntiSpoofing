...
import pdb
import importlib
from models.ghostnet100_MH.network import RGBDMH
from models.ghostnet100_MH.loss_fn import CMFL
...
class Trainer(BaseTrainer):
    ...
    def __init__(self, config):
        ...
        self.cmfl_loss = CMFL(alpha=1, gamma= 4, binary= False, multiplier=2)
