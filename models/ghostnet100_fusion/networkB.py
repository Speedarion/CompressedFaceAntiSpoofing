...
class RGBDMH(nn.Module):
    ...
    def forward(self, img):
        ...
        #FUSION B
        #Sum and average of 2 inputs
        input1 = (self.hooks['rgb1']+self.hooks['depth1'])/2
        ...
        #Sum and average of 3 inputs
        #fuse_op is joint representation map from previous fusion
        input2 = (fuse_op+self.hooks['rgb2']+self.hooks['depth2'])/3
        ...
        #repeat for input 3 and input 4
        input3 = (fuse_op+self.hooks['rgb3']+self.hooks['depth3'])/3
        ...
        input4 = (fuse_op+self.hooks['rgb4']+self.hooks['depth4'])/3
