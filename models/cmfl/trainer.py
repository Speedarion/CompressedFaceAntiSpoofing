...
import pdb
import importlib
from models.cmfl.network import RGBDMH
from models.cmfl.loss_fn import CMFL
...
class Trainer(BaseTrainer):
    ...
    def compute_loss(self,network,img):
        ...
        gap, op, op_rgb, op_d = network(network_input.cuda())
    ...
    def test_inference(self,network,img,starter,ender):
        ...
        return loss,op,op_rgb,op_d,curr_time/16
