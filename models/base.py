...
import importlib
from test import metric_report, metric_report_from_dict
...
class BaseTrainer(object):
    ...
    def train(self, ):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            # train for 1 epoch
            train_loss_avg = self._train_one_epoch(epoch, train_data_loader)
            ...
            if epoch % self.val_freq == 0:
                ...
                if val_output['MIN_HTER'] < self.val_metrics['MIN_HTER']:
                    self.counter = 0
                    self.val_metrics['MIN_HTER'] = val_output['MIN_HTER']
                    self.val_metrics['AUC'] = val_output['AUC']
                ...
                logging.info('Current Best MIN_HTER={}%, AUC={}%'.format(100*self.val_metrics['MIN_HTER'],
                                                                       100*self.val_metrics['AUC']))
    ...
    def _get_score_from_prob(self, output_prob):
        ...
        #use the score at the dimension of 1 to represent the probability of being genuine
        # label 1 for genuine , 0 for spoofing
        # below line extracts probability from index 1 , meaning it is the probability of image being genuine
